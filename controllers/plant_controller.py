...
def new_plant():
    all_plants = plant_repository.select_all()
    return render_template("inventory/new.html", all_plants = all_plants)
...
def create_plant():
    ...
    manufacturer_id  = manufacturer_repository.select(request.form['name'])
